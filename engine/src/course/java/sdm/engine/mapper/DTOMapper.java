...
public class DTOMapper {
    ...
    public DeleteItemFromStoreResponse createDeleteItemFromStoreResponse(List<Discount> removedDiscounts, SystemStore systemStore, StoreItem removedStoreItem) {
