...
public class LoginServlet extends HttpServlet {
    ...
    private final String CHAT_ROOM_URL = "../chatroom/salesAreas.html";
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (sdmController.isUserExists(usernameFromParameter)) {
                        ...
                        // the request dispatcher obtained from the servlet context is one that MUST get an absolute path
                        // (starting with'/')
