...
import course.java.sdm.engine.chat.SingleChatEntry;
...
public class ChatServlet extends HttpServlet {
    ...
    private void processRequest (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*
         * verify chat version given from the user is a valid number. if not it is considered an error and
         * nothing is returned back Obviously the UI should be ready for such a case and handle it properly
         */
        ...
        /*
         * Synchronizing as minimum as I can to fetch only the relevant information from the chat manager
         * and then only processing and sending this information onward Note that the synchronization here
         * is on the ServletContext, and the one that also synchronized on it is the chat servlet when
